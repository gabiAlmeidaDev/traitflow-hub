  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div className="glass-card p-6">
        <h3 className="text-lg font-semibold mb-4 text-foreground">Distribuição de Personalidades</h3>
      ...
      {/* Line Chart */}
      <div className="glass-card p-6">
        <h3 className="text-lg font-semibold mb-4 text-foreground">Evolução de Testes e Candidatos</h3>
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={lineData}>
            ...
            <Tooltip contentStyle={{ background: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: 8 }} />
            <Line type="monotone" dataKey="testes" stroke="hsl(var(--primary))" strokeWidth={3} dot={{ fill: 'hsl(var(--primary))' }} />
            <Line type="monotone" dataKey="candidatos" stroke="hsl(var(--success))" strokeWidth={3} dot={{ fill: 'hsl(var(--success))' }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="glass-card p-6 lg:col-span-2">
        <h3 className="text-lg font-semibold mb-4 text-foreground">Média de Scores por Característica</h3>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={barData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
            ...
            <YAxis stroke="hsl(var(--muted-foreground))" fontSize={12} />
            <Tooltip contentStyle={{ background: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: 8 }} />
            <Bar dataKey="score" fill="hsl(var(--info))" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
